// lib/frontend/widgets/chat_bubbles/neon_chat_bubble_pink.dart

import 'package:flutter/material.dart';

class NeonChatBubblePink extends StatelessWidget {
  final String text;
  final TextStyle? textStyle;

  const NeonChatBubblePink({
    Key? key,
    required this.text,
    this.textStyle,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final Color neonColor = Color(0xFFFFB6C1); // Baby Pink
