// lib/frontend/widgets/chat_bubbles/neon_chat_bubble_red.dart

import 'package:flutter/material.dart';

class NeonChatBubbleRed extends StatelessWidget {
  final String text;
  final TextStyle? textStyle;

  const NeonChatBubbleRed({
    Key? key,
    required this.text,
    this.textStyle,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final Color neonColor = Color(0xFFFF2B2B); // Bright Red
